...
(function(originalSettings) {
	...
	movements : [
		{
			source :
			'.csc-textpic-intext-left-nowrap:not(.csc-textpic-above, .csc-textpic-below) .csc-textpic-imagewrap, ' +
...
a7mobile.evalMobile.on.initialize.add(function() {
	...
	function correctHeight() {
		...
		jVpInclude.each(function() { vpInnerHeight -= jQuery(this).height(); });
...
window.a7fxsettings = { 'scrollFade': true };		window.a7js = window.a7js || {};
